...
alter table ADM_CONTRACT add constraint FK_ADM_CONTRACT_SOURCE foreign key (SOURCE_ID) references ADM_SOURCE_DESCRIPTION(ID)^
...
create index IDX_ADM_CONTRACT_SOURCE on ADM_CONTRACT (SOURCE_ID)^
-- end ADM_CONTRACT
...
alter table ADM_CONTRACT_FILE_DESCRIPTOR_LINK add constraint FK_ACFDL_CONTRACT foreign key (CONTRACT_ID) references ADM_CONTRACT(ID)^
alter table ADM_CONTRACT_FILE_DESCRIPTOR_LINK add constraint FK_ACFDL_FILE_DESCRIPTOR foreign key (FILE_DESCRIPTOR_ID) references SYS_FILE(ID)^
